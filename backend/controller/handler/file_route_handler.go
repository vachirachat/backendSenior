...
func NewFileRouteHandler(fs *service.FileService, room *service.RoomService, mw *auth.JWTMiddleware, proxyMw *auth.ProxyMiddleware, validate *utills.StructValidator) *FileRouteHandler {
